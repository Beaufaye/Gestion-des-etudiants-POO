      ...
      <div class="global-content">
        ...
        ?>
            ...
            <div class="cache">
                <div class="c-table">
                    <div class="bg-danger">
                    <form action="new.php" method="POST" class="row p-3 ">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <label for="inputnationalite" class="form-label text-light">Nationalité</label>
                            <select class="form-control"  name="nationalite" required>
                                ...
                                <option value="VCT">Saint-Vincentaise et Grenadine (Saint-Vincent-et-les Grenadines)
                                </option>
